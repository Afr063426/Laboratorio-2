...
datossin<-as.factor(datosBrasil[datosBrasil$TipoDeBono=="Tesouro Prefixado",])
datoscon<-as.factor(datosBrasil[datosBrasil$TipoDeBono=="Tesouro Prefixado com Juros Semestrais",])


ggplot( data =  datosgra, 
        mapping = aes(x =FechaDeMaduracion, y = FechaDeValoracion, group=FechaDeMaduracion, color=FechaDeMaduracion)) +
    geom_line()+
