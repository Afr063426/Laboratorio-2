...
str(datosBrasil$FechaDeValoracion)
...
mapping = aes(x=FechaDeValoracion, y = Precio,group=FechaDeMaduracion, color=as.factor(FechaDeMaduracion)))+
  geom_line()+
  ...
  labs(y = "Precios",x = "Tiempo",title = "Comportamiento de los precios")+
