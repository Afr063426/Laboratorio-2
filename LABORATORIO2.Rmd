...
(Profe, si sabe de alguna función para organizar el eje x nos podría ayudar, no entramos una que acodomara los datos según la fecha de maduración y no el orden alfabetico)
Al analizar estos datos cabe tener presente la siguiente tabla:
