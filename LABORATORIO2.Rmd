...
# datosDes[datosDes$TipoDeBono=="Tesouro Prefixado",]%>%ggplot(aes(x=FechaDeValoracion, y = Precio, group=FechaDeMaduracion, color=FechaDeMaduracion))+
#   geom_line()+
#   scale_color_discrete()+
#   labs(y = "Precios",x = "Tiempo",title = "Comportamiento de bonos cero cupón")+
...
# 
# ggplot(data=datosDes[datosDes$TipoDeBono=="Tesouro Prefixado com Juros Semestrais",], 
# mapping = aes(x=FechaDeValoracion, y = Precio,group=FechaDeMaduracion, color=FechaDeMaduracion))+
#   geom_line()+
#   scale_color_discrete()+
#   labs(y = "Precios",x = "Tiempo",title = "Comportamiento de bonos cero cupón")+
#   theme(legend.position="bottom")+
