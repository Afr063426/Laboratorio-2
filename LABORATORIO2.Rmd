...
```{r, fig.align="center",fig.width=5, fig.height=2.5, echo=FALSE, message=FALSE, warning=FALSE}
...
\par Como se aprecia, en los datos todas las variables no cuentan con las mismas observaciones, siendo así que se necesitan eliminar los datos del bono cuya fecha de maduración es el 01/07/2024 y además únicamente contar con las observaciones obtenidas a partir del 10/02/2020, que es donde se tiene registro del bono con fecha de maduración 01-01-2016.
