...
for (i in 1:length(parametrosGeneral)){
  datosCurvaAuxiliar<-data.frame(Maduracion=seq(1,10,length=100),Tasa=NS(unlist(lapply(parametrosGeneral,"[[",1)[i]),seq(0,10,length=100)),Etiqueta=rep(names(parametrosGeneral)[i],100))
