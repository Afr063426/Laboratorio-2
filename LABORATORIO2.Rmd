...
```
\par Siendo así que se necesitan eliminar los datos del bono cuya fecha de maduración es el 01/07/2024 y además y únicamente contar con las observaciones obtenidas a partir del 10/02/2020, que es donde se tiene registro del bono con fecha de maturación 01-01-2016.
...
datosDes<-datosDes%>%filter(FechaDeValoracion>=as.Date("10/02/2020",format="%d/%m/%Y"), FechaDeMaduracion!=as.Date("01/07/2024",format="%d/%m/%Y"))
