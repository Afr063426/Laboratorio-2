...
colnames(datos)=c("Date","1_mes","3_meses", "6_meses", "1_año", "2_años", "3_años","5_años","7_años", "10_años","20_años","30_años")
...
promedios1Mo$Maduration<-as.numeric(str_remove_all(promedios1Mo$Maduration,"[meses_años]"))*(str_detect(promedios1Mo$Maduration,"año")*12+str_detect(promedios1Mo$Maduration,"mes"))
promedios1Mo<-promedios1Mo[order(promedios1Mo$Maduration),]
promedios1Mo<-cbind(promedios1Mo, "Varianza"=apply(datos1Mo[,-1],2,sd))


promedios1Y$Maduration<-as.numeric(str_remove_all(promedios1Y$Maduration,"[meses_años]"))*(str_detect(promedios1Y$Maduration,"año")*12+str_detect(promedios1Y$Maduration,"mes"))
promedios1Y<-promedios1Y[order(promedios1Y$Maduration),]
promedios1Y<-cbind(promedios1Y, "Varianza"=apply(datos1Y[,-1],2,sd))

promedios10Y$Maduration<-as.numeric(str_remove_all(promedios10Y$Maduration,"[meses_años]"))*(str_detect(promedios10Y$Maduration,"año")*12+str_detect(promedios10Y$Maduration,"mes"))
...
Datosgra10Y<-Datosgra10Y[order(Datosgra10Y$Obtenido),]
...
ggplot(data = Datosgra10Y, aes(x =`Fecha de maduración` , y = Obtenido, group=`Fecha de maduración`)) + 
  geom_boxplot(aes(color = `Fecha de maduración`), alpha = 0.2) + 
...
Al analizar estos datos cabe tener presentar la siguiente tabla:

``` {r echo=FALSE, message=FALSE, warning=FALSE}

kable(promedios10Y  , format = "latex" , booktabs=TRUE , align = 'clcc' , caption = "Datos estadisticos (10 años)",)%>%
...
kable(promedios1Y  , format = "latex" , booktabs=TRUE , align = 'clcc' , caption = "Datos estadisticos (1 año)",)%>%
  kable_styling(full_width = F, position = "center", latex_options = "HOLD_position")
```
...
kable(promedios1Mo  , format = "latex" , booktabs=TRUE , align = 'clcc' , caption = "Datos estadisticos (1 mes)",)%>%
  kable_styling(full_width = F, position = "center", latex_options = "HOLD_position")
```
