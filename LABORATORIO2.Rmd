...
datosDes%>%ggplot(aes(x=FechaDeValoracion, y = Precio,group=FechaDeMaduracion, color=FechaDeMaduracion))+
  ...
  labs(y = "Precios",x = "Tiempo",title = "Comportamiento de bonos cero cupón")+theme_minimal()
```
...
```{r}
datosDes%>%ggplot(aes(x=FechaDeMaduracion, y = Precio,group=FechaDeMaduracion, color=FechaDeMaduracion))+
