...
parametros<-fitNS(t,datosPrueba$TempoDeMaduracao,datosPrueba$PU.Base.Manha,1000,datosPrueba$Juros/2)
tasasYield<-NS(unlist(parametros[1]),seq(0,10,length=100))
ggplot(,aes(x=seq(0,10,length=100),y=tasasYield))+geom_line()+geom_point(aes(x=datosPrueba1$TempoDeMaduracao,y=datosPrueba1$Spot))
```
